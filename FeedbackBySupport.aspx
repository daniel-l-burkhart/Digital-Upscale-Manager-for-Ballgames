...
<asp:Content ID="bodyContent" ContentPlaceHolderID="contentPlaceHolder" Runat="Server">
    <div id="margin">
        ...
        <br/>
        <asp:GridView ID="gvSupportFeedback" runat="server" DataSourceID="odsFeedback" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" Width="450px">
