...
<asp:Content ID="Content3" ContentPlaceHolderID="contentPlaceHolder" runat="Server">
    ...
    <br />
    <asp:DetailsView ID="dvCustomers" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="CustomerID" DataSourceID="sdsCustomersDetails" ForeColor="#333333" GridLines="None" Height="50px" Width="125px" HorizontalAlign="Center" OnItemDeleted="dvCustomers_ItemDeleted" OnItemInserted="dvCustomers_ItemInserted" OnItemUpdated="dvCustomers_ItemUpdated">
        <AlternatingRowStyle BackColor="White" />
